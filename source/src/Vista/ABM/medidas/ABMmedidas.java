 ...
 */
package vista.ABM.medidas;

/**
 *
 * @author pablo
 */
public class ABMmedidas extends javax.swing.JFrame {

    /**
     * Creates new form ABMmedidas
     */
    public ABMmedidas() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ABMmedidas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ABMmedidas().setVisible(true);
            }
        });
    }
